    ...
    return (
        <div className={props.className}>
            <div className='w-full h-full flex flex-row items-center justify-center'>
                <Tab className='w-24 rounded-tl-md overflow-clip' title={'All Vehicles'} bgColorClass={'bg-[#465691]'} textColorClass={'text-white'} count={0} />
                <Tab className='w-24' title={'Moving'} bgColorClass={'bg-green-300'} textColorClass={'text-green-600'} count={0} selected={true} selectedColorClass={'bg-green-600'} />
                <Tab className='w-24' title={'Idle'} bgColorClass={'bg-red-300'} textColorClass={'text-red-600'} count={0} />
